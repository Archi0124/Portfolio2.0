<template>
    <!-- component -->
<div class="min-h-screen bg-gray-100 min-w-screen fixed top-0 left-0 right-0 ">
    <!-- Header Logo Center -->
    <header class="w-full text-gray-700 bg-white border-t border-gray-100 shadow-sm body-font">
        <div class="container flex flex-col items-start justify-between p-6 mx-auto md:flex-row">
            ...
            <nav class="flex flex-wrap items-center justify-center pl-24 text-base md:ml-auto md:mr-auto">
                <a href="#_" class="mr-5 font-medium hover:text-gray-900">Работы студентов</a>
                <a href="#_" class="mr-5 font-medium hover:text-gray-900">Команды</a>
                <a href="#_" class="font-medium hover:text-gray-900">Рейтинг авторов</a>
            </nav>
            <div class="items-center h-full">
                <a href="#_" class="mr-5 font-medium hover:text-blue-600">Войти</a>
                <a href="#_"
                    class="px-4 py-4 text-xs font-bold text-white uppercase transition-all duration-150 bg-[#7879F1] hover:bg-blue-600 rounded shadow outline-none active:bg-teal-700 hover:shadow-md focus:outline-none ease">
                    Регистрация
                </a>
            </div>
        </div>
